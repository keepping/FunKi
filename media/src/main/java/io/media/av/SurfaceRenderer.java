...
class SurfaceRenderer implements GLSurfaceView.Renderer {
    ...
    private MediaControlVideo mMediaControlVideo;
    ...
    /**
     * Constructs SurfaceRenderer.
     * <p>
     *
     * @param recorder video encoder object
     */
    public SurfaceRenderer(MediaControlVideo recorder) {
        mMediaControlVideo = recorder;
    ...
    public void onSurfaceCreated(GL10 unused, EGLConfig config) {
        ...
        mFullScreenCamera = new FullFrameRect(new Texture2dProgram(Texture2dProgram.ProgramType.TEXTURE_EXT));
        // For texture overlay:
        ...
        mMediaControlVideo.onSurfaceCreated(mCameraTextureId);
        mFrameCount = 0;
    ...
    public void onDrawFrame(GL10 unused) {
        if (DEBUG) {
            if (mFrameCount % 30 == 0) {
                ...
                mMediaControlVideo.logSavedEglState();
            }
        }
        ...
        if (mMediaControlVideo.isSurfaceTextureReadyForDisplay()) {
            mMediaControlVideo.getSurfaceTextureForDisplay().updateTexImage();
            mMediaControlVideo.getSurfaceTextureForDisplay().getTransformMatrix(mSTMatrix);
