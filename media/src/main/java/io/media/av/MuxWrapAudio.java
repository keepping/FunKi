 ...
 * @hide
 */
public class MuxWrapAudio extends MuxWrap {
     ...
     */
    public MuxWrapAudio(int numChannels, int bitRate, int sampleRate, Muxer muxer) throws IOException {
        switch (numChannels) {
            case 1:
    ...
    /**
     * Depending on this method ties MuxWrapAudio
