 ...
 * @hide
 */
public class MediaControlAudio implements Runnable {
    private static final boolean TRACE = false;
    private static final boolean VERBOSE = false;
    private static final String TAG = "MediaControlAudio";
    ...
    private MuxWrapAudio mEncoderCore;

    private boolean mRecordingRequested;

    public MediaControlAudio(SessionConfig config) throws IOException {
        init(config);
    }

    private void init(SessionConfig config) throws IOException {
        mEncoderCore = new MuxWrapAudio(config.getNumAudioChannels(),
    ...
    private void startThread() {
        synchronized (mReadyFence) {
            ...
            Thread audioThread = new Thread(this, "MediaControlAudio");
