package com.hifunki.funki.widget.flowlayout;
...
//            lp.rightMargin = clp.rightMargin;
            ...
            } else
            {
                ...
                lp.setMargins((int) DisplayUtil.dip2Px(getContext(), 5), (int) DisplayUtil.dip2Px(getContext(), 5),(int) DisplayUtil.dip2Px(getContext(), 5), (int) DisplayUtil.dip2Px(getContext(), 5));
