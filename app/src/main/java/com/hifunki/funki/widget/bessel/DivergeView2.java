 ...
 */
public class DivergeView2 extends View implements Runnable {
...
//    private static final int mAlphaOffset = 50;
    ...
    public DivergeView2(Context context) {
        this(context, null);
    }

    public DivergeView2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DivergeView2(Context context, AttributeSet attrs, int defStyleAttr) {
