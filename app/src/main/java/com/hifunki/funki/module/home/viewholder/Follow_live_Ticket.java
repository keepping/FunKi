 ...
 * @value com.hifunki.funki.module.home.viewholder.Follow_live_Ticket.java
 * @link
 * @since 2017-03-16 15:11:11
 */
public class Follow_live_Ticket extends PowViewHolder<Post> {
    public Follow_live_Ticket(Activity activity, ViewGroup viewGroup) {
