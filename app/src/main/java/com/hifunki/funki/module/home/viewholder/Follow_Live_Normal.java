 ...
 * @value com.hifunki.funki.module.home.viewholder.Follow_Live_Normal.java
 * @link
 * @since 2017-03-16 10:13:13
 */
public class Follow_Live_Normal extends PowViewHolder<Post> {
    public Follow_Live_Normal(Activity activity, ViewGroup viewGroup) {
