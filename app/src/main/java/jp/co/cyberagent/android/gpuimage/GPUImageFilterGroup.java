...
import static jp.co.cyberagent.android.gpuimage.TextureRotationUtil.TEXTURE_NO_ROTATION;
...
//    private final FloatBuffer mGLTextureFlipBuffer; //del by bxq
    ...
    public GPUImageFilterGroup(List<GPUImageFilter> filters) {
        ...
        mGLCubeBuffer = ByteBuffer.allocateDirect(VERTEX_CUBE_NORMAL.length * 4)
                .order(ByteOrder.nativeOrder())
                .asFloatBuffer();
        mGLCubeBuffer.put(VERTEX_CUBE_NORMAL).position(0);
...
//        float[] flipTexture = TextureRotationUtil.getRotation(Rotation.NORMAL, false, true);//del by bxq
...
//        mGLTextureFlipBuffer.put(flipTexture).position(0);
    ...
    public void onOutputSizeChanged(final int width, final int height) {
        ...
        if (mMergedFilters != null && mMergedFilters.size() > 0) {
            ...
            int []currFbo = new int[1]; /*modify by bxq*/
            GLES20.glGetIntegerv(GLES20.GL_FRAMEBUFFER_BINDING, currFbo, 0); /*modify by bxq*/
            ...
            for (int i = 0; i < size - 1; i++) {
                ...
                GLES20.glBindFramebuffer(GLES20.GL_FRAMEBUFFER, currFbo[0]); /*modify by bxq*/
            }
        }
    }
