...
public class MessageParser extends AbstractParser implements OnMessagePacketReceived {
    ...
    public void onMessagePacketReceived(Account account, MessagePacket original) {
        ...
        if ((body != null || pgpEncrypted != null || oobUrl != null) && !isMucStatusMessage) {
...
//				}
            ...
            if (conversationMultiMode) {
                ...
                Jid trueCounterpart;
                if (Config.PARSE_REAL_JID_FROM_MUC_MAM) {
            ...
            ImManager.getDefault().invokeUpdateConversation(conversation, message);
