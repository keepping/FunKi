...
public class SimpleTextCacheStuffer extends BaseCacheStuffer {
    ...
    public void measure(BaseDanmaku danmaku, TextPaint paint, boolean fromWorkerThread) {
        ...
        if (danmaku.lines == null) {
            if (danmaku.text == null) {
                ...
                w = paint.measureText(danmaku.text.toString()) + 200;
                textHeight = getCacheHeight(danmaku, paint) + 100;
            }
    ...
    protected void drawText(BaseDanmaku danmaku, String lineText, Canvas canvas, float left, float top, TextPaint paint, boolean fromWorkerThread) {
        if (lineText != null) {
            ...
            WeakReference bitmapWeakReference = danmaku.tag instanceof WeakReference ? (WeakReference)danmaku.tag : null;

            Object obj = bitmapWeakReference==null ? null : bitmapWeakReference.get();
            Bitmap bitmap =  (Bitmap)obj;

            if(bitmap!=null){
                RectF rect = new RectF((int)left,(int)top,(int)left+200,(int)top+100);
                canvas.drawBitmap(bitmap,left,top,paint);

                System.out.println("...........................................111");
            }else {
                System.out.println("......................................"+danmaku.tag);
                System.out.println("...........................................222");
            }


            canvas.drawText(danmaku.text.toString(), left+200, top+100, paint);
        }
    }
